...
privileges_list = ['Can see IP', 'Can ban (with reason)', 
                  'Can see hidden users']

# Store the list in self.privileges of class Privileges
neo.privileges.privileges = privileges_list

# Call method to display privileges of the instance
