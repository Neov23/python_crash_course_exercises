...
for roll_num in range(50_000):
    result = dice_1.roll_dice() + dice_2.roll_dice() + dice_3.roll_dice()
...
possibilities = list(range(3, max_result + 1))
data = [Bar(x=possibilities, y= frequencies)]

x_axis_config = {'title': 'Result', 'dtick': 1}
y_axis_config = {'title': 'Frequency of Result'}
my_layout = Layout(title='Results of rolling three D6 dices 50.000 times',
    xaxis=x_axis_config, yaxis=y_axis_config)
offline.plot({'data': data, 'layout': my_layout}, filename='exercise_15_07')