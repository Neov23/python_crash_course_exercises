...
class Game:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("exercise_14_03")
        self.bg_color = (0, 0, 0)
    ...
    def _initialize_game(self):
        ...
        # Initialize enemy's position and direction
        self.enemy.rect.midright = self.screen_rect.midright
        self.enemy.y = float(self.enemy.rect.y)
        self.enemy.direction = 1

        # Remove all active bullets and set removed_bullets to 0
        self.bullets.empty()
        self.removed_bullets = 0
